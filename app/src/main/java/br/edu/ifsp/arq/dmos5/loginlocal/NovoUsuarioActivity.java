package br.edu.ifsp.arq.dmos5.loginlocal;
...
public class NovoUsuarioActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        novoUsuarioEditText =
        findViewById(R.id.edittext_novo_usuario);
    ...
    private void adicionarBD(){
        ...
        for(User u : userList){
            ...
            try {jsonObject.put("username", u.getUsername());
                jsonObject.put("password", u.getPassword());
                jsonArray.put(jsonObject);
            }
            catch (JSONException e){Log.e(getString(R.string.tag), getString(R.string.erro_recupera_lista));
            }
        }
